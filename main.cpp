...
/*-------------------------------------------------------------------*/
	...
	GLfloat vertices[][3] ={{160,390,-70},{425,390,-70},
					...
					{320,467,-70},{320,520,-70},{380,520,-70},
					{380,390,-70},{320,390,-70}};
...
void text2d()
{
   char string2[]="STAMFORD";
   void *font2=GLUT_BITMAP_TIMES_ROMAN_24;
   int k;
   glColor3f(0.0,0.0,0.0);
   glRasterPos3f(255,400,70);
   for(k=0;k<strlen(string2);k++)
   glutBitmapCharacter(font2,string2[k]);

   char string3[]="UNIVERSITY OF";
   void *font3=GLUT_BITMAP_TIMES_ROMAN_24;

   glColor3f(0.0,0.0,0.0);
   glRasterPos3f(253,380,70);
   for(k=0;k<strlen(string3);k++)
   glutBitmapCharacter(font3,string3[k]);
...
void text3d()
{
  ...
  int k;
   glColor3f(0.0,0.0,0.0);
  glRasterPos3f(230+150,400+65,70);
...
char string9[]="ATIK.AL.MAHMUD";
void *font9=GLUT_BITMAP_HELVETICA_18;

glColor3f(0.0,0.0,0.0);


glRasterPos3f(700,190+100,0);
...
char string4[]="ASADUR.RAHMAN";
void *font4=GLUT_BITMAP_HELVETICA_18;

glColor3f(0.0,0.0,0.0);


glRasterPos3f(700,160+100,0);
...
char string6[]="SAIMA_SIDDIQUE_TASHFIA";
